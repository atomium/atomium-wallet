...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/atomium"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutAtomiumAction = new QAction(MainWindow);
        m_aboutAtomiumAction->setObjectName(QStringLiteral("m_aboutAtomiumAction"));
        m_aboutAtomiumAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutAtomiumAction);
        ...
        QObject::connect(m_aboutAtomiumAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutAtomiumAction->setText(QApplication::translate("MainWindow", "About Atomium", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        m_communityForumAction->setText(QApplication::translate("MainWindow", "Join Forum", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND ATOMIUM", Q_NULLPTR));
