...
const char COMMUNITY_FORUM_URL[] = "http://forum.atomiumproject.com";
const char REPORT_ISSUE_URL[] = "http://atomiumproject.com/#contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Atomium Wallet %1").arg(Settings::instance().getVersion()));
